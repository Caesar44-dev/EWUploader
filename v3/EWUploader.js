...
function uploadToDriveAndWordpress(data) {
  try {
    ...
    const spreadsheetId = '1dc0Swt5NsdFw5ZzrycmfzyOIrkxTvJeNDD9GXlOwRD4'; // id hoja de excel
    ...
    const newRowData = [
      fileNameWithoutExtension, driveResponse.url,
      fileName2WithoutExtension, wordpressResponse.url
    ];
